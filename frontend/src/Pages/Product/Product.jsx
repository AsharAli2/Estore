...
export default function Product() {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Loading
        open={checkingAuth || addingToCart}
        ...
        <>
          ...
          <Grid container spacing={4} sx={{ mb: 4 }}>
            ...
            <Grid item xs={12} md={6}>
              <Paper
                elevation={2}
                sx={{ p: 2, borderRadius: 2, backgroundColor: "#f8f9fa" }}
              >
                {/* Main Image */}
                <Box
                  sx={{
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ pl: { xs: 0, md: 2 } }}>
                ...
                >
                  <Rating
                    value={SingleProduct.averageRating || 0}
                    readOnly
                    size="small"
                  />
                ...
                <Box sx={{ mb: 3, pb: 2, borderBottom: "1px solid #ecf0f1" }}>
                  <Typography
                    variant="h5"
                    sx={{ fontWeight: 700, color: "#3498db", mb: 1 }}
                  >
                ...
                <Typography
                  variant="body1"
                  sx={{ mb: 3, color: "#34495e", lineHeight: 1.7 }}
                >
            ...
            <Grid container spacing={3} sx={{ mb: 4 }}>
              <Grid item xs={12} sm={4}>
                <Paper sx={{ p: 2, textAlign: "center", borderRadius: 2 }}>
                  <Typography
                    variant="h4"
                    sx={{ fontWeight: 700, color: "#3498db" }}
                  >
                ...
                <Stack spacing={2}>
                  <Box>
                    ...
                    <Rating
                      ...
                      disabled={userHasReviewed || user === null}
                      size="large"
                    />
                  </Box>
                  <TextField
